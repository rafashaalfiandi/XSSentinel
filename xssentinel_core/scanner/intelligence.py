...
from .models import *
from .parsers import *
from .contexts import context_snippets
...
def analyze_csp(headers: dict[str, str], body: str, base_url: str) -> CSPAnalysis:
    ...
    try:
        parser.feed(body)
    except Exception as exc:  # noqa: BLE001 - CSP analysis should degrade to header-only parsing.
...
def html_context_snippets(body: str, payload: str, max_items: int = 4) -> list[str]:
    ...
    return context_snippets(body, needles, max_items=max_items)
