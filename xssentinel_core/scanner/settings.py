...
payloads from the internal payload catalog, checks HTTP reflection, and optionally confirms
...
PAYLOAD_FILE = BASE_DIR / "xssentinel_core" / "manifest" / "payloads" / "xss-payloads.txt"
