    ...
    for t in targets:
        ...
        all_display_targets.append({
            ...
            'order': (0 if t.method == "POST" else 1,
                     {"high-value-form": 0, "form": 1, "js-post-json": 2, "js-post": 3, "direct-all-params": 4, "direct": 5, "html-standalone": 6, "link": 7, "js-single": 8, "grouped": 9, "fallback": 10, "unknown": 11}.get(source, 12))
        })
